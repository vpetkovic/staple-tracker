...
export interface SubtreePlan {
  ...
  estimatedSeconds: number | null;
  source: PlanSource;
  /** The bottom-up plan: sum of the live (not cancelled) direct children's effective plans; null when no live descendant has one. */
  ...
  /** Unplanned units: live descendants with no children, no estimate and no estimated ancestor beneath this issue. */

...
| `planSummary.remainingPath.seconds` | plan | The same chain with `done` units weighing 0: what is left of the plan. A unit in progress weighs its full estimate. | cli.md | open units remain and none is planned |

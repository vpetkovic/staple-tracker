...
describe("a server started with no workspace in reach", () => {
  ...
  it("still connects and still lists all 43 tools", async () => {
    ...
    // get_setting / set_setting, STA-168's seven queue tools and STA-249's
    // hub_unregister / hub_prune / cross_unlink.
